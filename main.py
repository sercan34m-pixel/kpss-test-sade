...
# --- 1. AYARLAR (ANDROID İÇİN GÜVENLİ YOL) ---
# Android dosya sisteminde kaybolmamak için bu yöntem şarttır.
...
def main(page: ft.Page):
    # --- DÜZELTME: İKON KODU SİLİNDİ (ÇÖKMEYİ ÖNLER) ---
    # page.window_icon...  <-- SİLDİK
    ...
    # --- YÜKLEME SİSTEMİ (TELEFON HAFIZASI) ---
    def yukle():
        try:
    ...
    # --- KAYIT SİSTEMİ (TELEFON HAFIZASI) ---
    def kaydet():
        try:
    ...
    def view_home():
        ...
        icerik_kolonu = ft.Column(
            controls=[
                ...
                ], spacing=10, horizontal_alignment=ft.CrossAxisAlignment.CENTER), padding=20),
...
# =============================================================================
# !!! İŞTE SİHİRLİ DOKUNUŞ: BU SATIR OLMADAN ANDROID ÇALIŞMAZ !!!
# =============================================================================
